import { UserRole, ModuleName, ActionType, Permission, RoleDefinition } from "../content/schemas";

const ROLE_REGISTRY: RoleDefinition[] = [
  {
    role: 'SuperAdmin',
    permissions: [
      { module: 'Navigation', actions: ['view', 'create', 'edit', 'delete', 'reorder'] },
      { module: 'Pages', actions: ['view', 'create', 'edit', 'publish', 'delete'] },
...
export const permissionService = {
  hasPermission: async (role: UserRole, module: ModuleName, action: ActionType): Promise<boolean> => {
