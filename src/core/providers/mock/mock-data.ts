...
export const MOCK_NAVIGATION: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'gov-vote', label: 'My Voting', href: '/governance/my-voting', roles: ['phase1', 'phase2', 'phase3', 'BoardMember', 'admin'], isActive: true, order: 5 },
      { id: 'gov-sep', label: '---', roles: ['public', 'phase1', 'phase2', 'phase3', 'admin'], isActive: true, order: 6 },
      { id: 'gov-esg', label: 'ESG & Risk Management', href: '/#risk', roles: ['public', 'phase1', 'phase2', 'phase3', 'admin'], isActive: true, order: 7 },
      { id: 'gov-policy', label: 'Policies & Framework', href: '#', roles: ['public', 'phase1', 'phase2', 'phase3', 'admin'], isActive: true, order: 8 },
      { id: 'gov-filings', label: 'Legal & Regulatory Filings', href: '#', roles: ['public', 'phase1', 'phase2', 'phase3', 'admin'], isActive: true, order: 9 },
      { id: 'gov-dash', label: 'Compliance Dashboard', href: '/admin/dashboard', roles: ['public', 'phase1', 'phase2', 'phase3', 'admin'], isActive: true, order: 10 },
      { id: 'gov-audit', label: 'Audit Reports', href: '#', roles: ['public', 'phase1', 'phase2', 'phase3', 'admin'], isActive: true, order: 11 },
    ]
  },
  {
    id: 'nav-resources',
