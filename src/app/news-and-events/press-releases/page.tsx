...
export const metadata: Metadata = {
    title: 'Press Releases | Baalvion',
    description: 'Official press releases from Baalvion.',
};
        ...
        <>
            ...
            <section className="py-16 md:py-24 bg-white">
                <div className="container mx-auto px-4 text-center text-black">
                    ...
                    <p className="text-gray-600 mt-4">Our latest press releases will be listed here.</p>
                </div>
            </section>
        </>
    );
